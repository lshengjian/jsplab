"""esper is a lightweight Entity System (ECS) for Python, 
folk from  https://github.com/benmoran56/esper
"""
...
class World:
    def __init__(self):
        self._entity_count: "_count[int]" = _count(start=1)
    ...
    @_overload
    def try_components(self,entity: int, __c1: _Type[_C], __c2: _Type[_C2]) -> _Tuple[_C, _C2]:
        ...


    @_overload
    def try_components(self,entity: int, __c1: _Type[_C], __c2: _Type[_C2], __c3: _Type[_C3]) -> _Tuple[_C, _C2, _C3]:
        ...


    @_overload
    def try_components(self,entity: int, __c1: _Type[_C], __c2: _Type[_C2], __c3: _Type[_C3], __c4: _Type[_C4]) -> _Tuple[_C, _C2, _C3, _C4]:
        ...


    def try_components(self,entity: int, *component_types: _Type[_C]) -> _Optional[_Tuple[_C, ...]]:
        ...
        if all(comp_type in self._entities[entity] for comp_type in component_types):
            return [self._entities[entity][comp_type] for comp_type in component_types]  # type: ignore[return-value]
        return None
    ...
    def timed_process(self,*args: _Any, **kwargs: _Any) -> None:
        ...
        for processor in self._processors:
            ...
            processor.process(*args, **kwargs)
            self.process_times[processor.__class__.__name__] = int((_time.process_time() - start_time) * 1000)
