...
class JssEnv(gym.Env):
    def __init__(self, env_config=None,render_mode=None):
        ...
        if env_config is None:
            env_config = {
                "instance_path": Path(__file__).parent.parent.absolute() / "instances" / "d01"
            }
